    ...
    hero: [
      {
        ...
        colors: [
          { color: "rgba(229, 211, 197, 0.15)", stop: "0%" },
          { color: "rgba(229, 211, 197, 0.08)", stop: "40%" },
          { color: "rgba(229, 211, 197, 0)", stop: "70%" },
        ],
        blur: "80px",
        opacity: 1,
      },
      {
        ...
        colors: [
          { color: "rgba(212, 165, 116, 0.12)", stop: "0%" },
          { color: "rgba(212, 165, 116, 0.06)", stop: "40%" },
          { color: "rgba(212, 165, 116, 0)", stop: "70%" },
        ],
        blur: "70px",
        opacity: 1,
      },
      {
        ...
        colors: [
          { color: "rgba(201, 168, 130, 0.1)", stop: "0%" },
          { color: "rgba(201, 168, 130, 0.05)", stop: "40%" },
          { color: "rgba(201, 168, 130, 0)", stop: "70%" },
        ],
        blur: "60px",
        opacity: 1,
      },
      {
        ...
        colors: [
          { color: "rgba(229, 211, 197, 0.14)", stop: "0%" },
          { color: "rgba(229, 211, 197, 0.07)", stop: "40%" },
          { color: "rgba(229, 211, 197, 0)", stop: "70%" },
        ],
        blur: "75px",
        opacity: 1,
      },
      {
        ...
        colors: [
          { color: "rgba(212, 165, 116, 0.13)", stop: "0%" },
          { color: "rgba(212, 165, 116, 0.065)", stop: "40%" },
          { color: "rgba(212, 165, 116, 0)", stop: "70%" },
        ],
        blur: "85px",
        opacity: 1,
      },
      {
        ...
        colors: [
          { color: "rgba(229, 211, 197, 0.11)", stop: "0%" },
          { color: "rgba(229, 211, 197, 0.055)", stop: "40%" },
          { color: "rgba(229, 211, 197, 0)", stop: "70%" },
        ],
        blur: "65px",
        opacity: 1,
      },
      {
        ...
        colors: [
          { color: "rgba(201, 168, 130, 0.09)", stop: "0%" },
          { color: "rgba(201, 168, 130, 0.045)", stop: "40%" },
          { color: "rgba(201, 168, 130, 0)", stop: "70%" },
        ],
        blur: "55px",
        opacity: 1,
